            ...
            <Grid item xs={6}>
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} style={{ textAlign: "left", paddingLeft: "10vh" }}>
                  <Button style={{ fontSize: "1.1rem", backgroundColor: "green", padding: "1vh 5vh", color: "white" }}>View Schemes</Button>
                </Grid>
              </Grid>
            </Grid>
            <Grid item xs={6}>
          ...
          <Grid item xs={12}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={4} style={{ paddingLeft: "5vh", paddingTop: "9vh", textAlign: "left" }}>
                <Button style={{ fontSize: "1.1rem", backgroundColor: "green", padding: "1vh 5vh", color: "white" }}>Ask Us Your Doubts</Button>
              </Grid>
            </Grid>
          </Grid>
        </Grid>
